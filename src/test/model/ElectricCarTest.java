...
public class ElectricCarTest {
    private ElectricCar testCar1;
    private ElectricCar testCar2;
    private ElectricCar testCar3;

    @BeforeEach
    public void setUp() {
        testCar1 = new ElectricCar("car1", 100);
        testCar2 = new ElectricCar("car2", 200);
        testCar2.setCurrentMileage(1);
        testCar3 = new ElectricCar("car3", 300);
        testCar3.setMonthsOwned(10);
        testCar3.setMonthlyExpenses(20);
        testCar3.setCurrentMileage(1000);
        testCar3.setChargingCost(250);
    }
